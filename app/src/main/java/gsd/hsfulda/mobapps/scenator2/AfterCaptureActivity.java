...
public class AfterCaptureActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_PHOTO_URI =
            "gsd.hsfulda.mobapps.scenator2.AfterCaptureActivity.extra.PHOTO_URI";
    public static final String EXTRA_PHOTO_DATA_PATH =
            "gsd.hsfulda.mobapps.scenator2.AfterCaptureActivity.extra.PHOTO_DATA_PATH";
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        getMenuInflater().inflate(R.menu.activity_aftercapture, menu);
        return true;
    }
    ...
    private void deletePhoto() {
        final AlertDialog.Builder alert = 
                new AlertDialog.Builder(AfterCaptureActivity.this);
